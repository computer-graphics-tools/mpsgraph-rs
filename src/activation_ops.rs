...
impl MPSGraph {
    ...
    pub fn relu_gradient_with_incoming_gradient(&self, 
    ...
    pub fn sigmoid_gradient_with_incoming_gradient(&self, 
        gradient: &MPSGraphTensor, 
        source: &MPSGraphTensor, 
        name: Option<&str>
    ) -> MPSGraphTensor {
    ...
    pub fn softmax_gradient_with_incoming_gradient(&self, 
        gradient: &MPSGraphTensor, 
        source: &MPSGraphTensor, 
        axis: i64,
        name: Option<&str>
    ...
    pub fn leaky_relu_with_alpha_tensor(&self, 
        x: &MPSGraphTensor, 
    ...
    pub fn leaky_relu_gradient_with_incoming_gradient(&self, 
        gradient: &MPSGraphTensor, 
        source: &MPSGraphTensor, 
        alpha: f32,
        name: Option<&str>
