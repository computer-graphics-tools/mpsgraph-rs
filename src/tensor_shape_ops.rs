...
impl MPSGraph {
    ...
    pub fn broadcast(&self, x: &MPSGraphTensor, shape: &[i64], name: Option<&str>) -> MPSGraphTensor {
        unsafe {
            let name_obj = match name {
                Some(s) => NSString::from_str(s).as_raw_object(),
                None => ptr::null_mut(),
    ...
    pub fn cast(&self, x: &MPSGraphTensor, data_type: crate::core::MPSDataType, name: Option<&str>) -> MPSGraphTensor {
        unsafe {
            let name_obj = match name {
                Some(s) => NSString::from_str(s).as_raw_object(),
                None => ptr::null_mut(),
    ...
    pub fn stack(&self, tensors: &[MPSGraphTensor], axis: i64, name: Option<&str>) -> MPSGraphTensor {
        unsafe {
            let name_obj = match name {
                Some(s) => NSString::from_str(s).as_raw_object(),
                None => ptr::null_mut(),
            ...
            let raw_tensors: Vec<*mut AnyObject> = tensors.iter()
                .map(|t| t.0)
                .collect();
    ...
    pub fn split(&self, x: &MPSGraphTensor, num_splits: i64, axis: i64, name: Option<&str>) -> Vec<MPSGraphTensor> {
        unsafe {
            let name_obj = match name {
                Some(s) => NSString::from_str(s).as_raw_object(),
                None => ptr::null_mut(),
    ...
    pub fn expand_dims(&self, x: &MPSGraphTensor, axes: &[i64], name: Option<&str>) -> MPSGraphTensor {
        unsafe {
            let name_obj = match name {
                Some(s) => NSString::from_str(s).as_raw_object(),
                None => ptr::null_mut(),
    ...
    pub fn tile(&self, x: &MPSGraphTensor, multiples: &[i64], name: Option<&str>) -> MPSGraphTensor {
        unsafe {
            let name_obj = match name {
                Some(s) => NSString::from_str(s).as_raw_object(),
                None => ptr::null_mut(),
    ...
    pub fn pad(&self, x: &MPSGraphTensor, padding: &[i64], constant: f32, name: Option<&str>) -> MPSGraphTensor {
        unsafe {
            let name_obj = match name {
                Some(s) => NSString::from_str(s).as_raw_object(),
                None => ptr::null_mut(),
    ...
    pub fn space_to_depth(&self, x: &MPSGraphTensor, block_size: i64, name: Option<&str>) -> MPSGraphTensor {
        unsafe {
            let name_obj = match name {
                Some(s) => NSString::from_str(s).as_raw_object(),
                None => ptr::null_mut(),
    ...
    pub fn depth_to_space(&self, x: &MPSGraphTensor, block_size: i64, name: Option<&str>) -> MPSGraphTensor {
        unsafe {
            let name_obj = match name {
                Some(s) => NSString::from_str(s).as_raw_object(),
                None => ptr::null_mut(),
